...
<input type="button" onClick="window.location.href='?page=<?php echo base64_encode('Tambah Bandara'); ?>'" value="Add Bandara"> 
				...
				<th width="1%"> <font color="#fff">No.</font> </th>
					<th width="1%"></th>
					<th width="20%"> <font color="#fff">KODE BANDARA</font> </th>
					<th width="20%"> <font color="#fff">NAMA BANDARA</font> </th>
					<th width="20%"> <font color="#fff">TITIK POINT</font> </th>
				...
				<tbody >
					<?php 
					$no=1;
						$query=mysql_query("select * from bandara ORDER BY kode_bandara ASC")or die(mysql_error());
					...
					<td><?php echo $no ?>.</td>
						...
						<td><?php echo $row['kode_bandara'] ?></td>
						<td><?php echo $row['bandara'] ?></td>
						<td><?php echo $row['lokasi_point'] ?></td>
						<td width="2%"><a href="?page=<?php echo base64_encode('Edit Bandara'); ?><?php echo"&&id=$id";?>"><img src="images/icn_edit.png"></a></td>
						<td width="2%"><a href="?page=<?php echo base64_encode('Data Bandara'); ?><?php echo"&&id=$id";?>" onClick="return confirm('Apakah Anda Yakin Akan Menghapus Data Terpilih?')"><img src="images/icn_trash.png"></a></td>
					</tr>
                    <?php 
					$no++;
					} 
